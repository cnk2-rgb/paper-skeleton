...
We will review prior literature across several themes to ground our research. To examine the general impact of online censorship on LLMs, we will reference [Ahmed and Knockel, 2024] and [Glukhov et al., 2023], who show how censorship shapes model outputs and information flow. To understand how censorship restricts data access, we will draw on [Hoang et al., 2024] and studies on firewalls and WAFs [Wu et al., 2023], which document technical limits on web content and resulting data gaps. To explore how censored or biased data influences LLM behavior, we will examine studies on bias and omission [Yang and Roberts, 2021; Hovy and Prabhumoye, 2021; Noels et al., 2025] and on disinformation and data poisoning [Jiang et al., 2023; Danet, 2025; Maus et al., 2023]. Finally, to contextualize applications of censorship-like techniques for IP protection, we will review research on AI and copyright [Wei et al., 2024; Barbera, 2025] to understand existing methods and their limitations.
