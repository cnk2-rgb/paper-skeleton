...
Note that all labels were removed from the justifications in the original LIAR2 dataset. Our results indicate that ChatGPT is not completely able to distinguish disinformation rhetoric, especially on social media platforms. Furthermore, it may reproduce disinformation rhetoric, as seen through some of the rationales given. 
